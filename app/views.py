...
import razorpay
client = razorpay.Client(auth=("rzp_test_oYDOnLLW6wtfe9", "Ry1Jvkocw2NmgjlYVQwMrDH7"))
...
def checkout(request):
	...
	return render(request, 'app/payment.html', {'add':add, 'cart_items':cart_items, 'totalcost':totalamount})
